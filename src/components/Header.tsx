    ...
    <header className={styles.header}>
      <div className={styles.inner}>
        ...
        <nav className={styles.nav}>
          <a href="#arena" className={styles.navLink}>Arena</a>
          <a href="#history" className={styles.navLink}>History</a>
          <a href="#claims" className={styles.navLink}>Claims</a>
        </nav>
        ...
        <div className={styles.walletArea}>
          {publicKey && (
            <div className={styles.balanceBadge}>
              ...
              <span className={styles.balanceValue}>{solBalance.toFixed(3)}</span>
            </div>
          )}
          <WalletMultiButton />
        </div>
